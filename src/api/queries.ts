...
// Legal docs
export function useListLegalDocs(propertyId?: string) {
  return useQuery({
...
export function useUploadLegalDoc(propertyId: string) {
  return useMutation({
    mutationFn: async (payload: { documentType?: string; base64: string }) => {
...
export function useGetLegalDoc(propertyId: string) {
  return useMutation({
...
export function useDeleteLegalDoc(propertyId: string) {
  return useMutation({
    mutationFn: async (id: string) => {
...
export function useReplaceLegalDoc(propertyId: string) {
  return useMutation({
    mutationFn: async (payload: { id: string; base64: string }) => {
...
// Contracts
export function useContractsList(propertyId?: string) {
  return useQuery({
...
export function useCreateContract() {
  return useMutation({
    mutationFn: async (payload: { propertyId: string; buyerUserId: string; sellerUserId: string; contractType?: string; body: string }) => {
...
export function useCreateRole() {
  return useMutation({
    mutationFn: async (payload: { name?: string; description?: string; isSystemGenerated?: boolean; companyId?: string }) => {
...
export function useListRolesByCompany(companyId?: string) {
  return useQuery({
...
export function useAssignUserRole() {
  return useMutation({
    mutationFn: async (payload: { userId?: string; roleId?: string; companyId?: string }) => {
...
export function useListPermissionsByCompany(companyId?: string) {
  return useQuery({
